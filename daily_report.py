...
TEXT_FIELDS_ORDER = [
    ("fio", "Введите ФИО координатора(Фамилия И.О.):", "{}1{}"),
    ("team", "Введите название команды:", "{}2{}"),
    ("date", "Введите дату (например 10.08.2025):", "{3}"),
    ("address", "Введите адрес :", "{4}"),
    ("bags", "Введите количество мешков:", "{5}"),
    ("fighters", "Введите кол-во бойцов:", "{6}")
]
